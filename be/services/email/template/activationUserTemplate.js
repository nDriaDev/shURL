export default function activationUserTemplate({linkRef}) {
	return `<!doctype html>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h3 style="text-align: center;"><span style="color:#FFFFFF"><span style="font-size:23px"><span style="font-family:open sans,helvetica neue,helvetica,arial,sans-serif">Thank you for signing in!</span></span></span></h3>

<h3 style="text-align: center;margin-bottom:20px"><span style="color:#FFFFFF"><font size="2">Please click on button below to active your account</font></span></h3>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                <a class="mcnButton " title="Active account" href="${linkRef}" target="_blank" style="font-weight: bold;letter-spacing: 2px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Active account</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<a href="${linkRef}" target="_blank">Active link</a>
                        </td>
                    </tr>
                </tbody></table>
\t\t\t\t<!--[if mso]>
